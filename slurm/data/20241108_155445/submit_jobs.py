...
if __name__ == '__main__':
    ...
    max_time = dt.timedelta(hours=24)
    if max_time.days > 0:
    ...
    for file in os.listdir('benchmarks/cached_schedules/'):
        if file == 'random_t_1000_200_0.lss':
    ...
    sweep_params = {
        ...
        'decoder_latency_or_dist_filename':list(np.geomspace(1.2, 120, 9)),
        'rng':[0],
    ...
    def config_filter(cfg):
        return (cfg['speculation_mode'] == None and cfg['speculation_accuracy'] == 0) or (cfg['speculation_mode'] == 'separate' and cfg['speculation_accuracy'] > 0)
